...
def test_timeCSV():    
    assert getTimeextend.getCSVtime(__location__+'/testdata/Behindertenparkplaetze_Duesseldorf.csv', 'time') == b
...
def test_timeNetCDF():    
    assert getTimeextend.getNetCDFtime(__location__+'/testdata/ECMWF_ERA-40_subset', 'time') == "2002-07-01T12:00:00.000000000" "2002-07-31T18:00:00.000000000"
