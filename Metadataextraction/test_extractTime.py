...
def test_answerW():
    ...
    assert extractTool.getMetadata(filepath, 'bbox', 'single', True) == [[7.6016807556152335, 51.94881477206191, 7.647256851196289, 51.974624029877454], [None], ['2018-11-14 00:00:00', '2018-11-14 00:00:00']]
